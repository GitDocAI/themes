...
export function Parameters({ parameters }: Props) {
  ...
  const renderConstraints = (schema: any) => {
    ...
    if (schema.minimum !== undefined)
      constraints.push(
        <span className="text-gray-800 dark:text-gray-300">Required range x &ge;
              <span
                className="rounded-md bg-blue-100 dark:bg-blue-900/30 px-2 py-0.5 text-xs text-gray-800 dark:text-gray-300"
              >
          {schema.minimum}
            </span>
        </span>
    ...
    if (schema.maximum !== undefined)
      constraints.push(
        <span className="text-gray-800 dark:text-gray-300">Required range x &le;
              <span
                className="rounded-md bg-blue-100 dark:bg-blue-900/30 px-2 py-0.5 text-xs text-gray-800 dark:text-gray-300"
              >
          {schema.maximum}
