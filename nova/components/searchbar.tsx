...
export default function SearchBar() {
  ...
  return (
    <>
      <button
        onClick={openModal}
        className="w-full flex items-center space-x-2 rounded-full border border-nova-200 dark:border-nova-700 bg-nova-50/80 dark:bg-nova-800/80 px-3 py-1.5 text-sm text-nova-600 dark:text-nova-300 transition-all duration-300 hover:border-accent-primary/60 hover:bg-accent-primary/5 dark:hover:bg-accent-primary/10 hover:shadow-lg hover:shadow-accent-primary/10 focus:outline-none focus:ring-2 focus:ring-accent-primary/20 active:scale-98 group backdrop-blur-sm magnetic-effect shimmer-effect"
      >
        <i className="w-3.5 h-3.5 pi pi-search text-nova-400 dark:text-nova-500 group-hover:text-accent-primary transition-colors duration-300" />
        <span className="text-nova-500 dark:text-nova-400 flex-1 text-left text-sm group-hover:text-nova-700 dark:group-hover:text-nova-200 transition-colors duration-300">Search...</span>
        {isMac !== null && (
          <kbd className="text-xs bg-nova-200/60 dark:bg-nova-700/60 px-1.5 py-0.5 rounded border border-nova-300/50 dark:border-nova-600/50 text-nova-600 dark:text-nova-400 font-mono group-hover:bg-accent-primary/10 group-hover:border-accent-primary/30 transition-all duration-300">
            {isMac ? '⌘K' : '⌃K'}
          </kbd>
        )}
      </button>
