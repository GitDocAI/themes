...
const SetPassword: React.FC<SetPasswordProps> = ({ config }) => {
  ...
  useEffect(() => {
    document.title = `${projectName} - Set Password`
  ...
  const confirmError = confirmTouched && !confirmPassword ? 'Please confirm your password' :
                       confirmTouched && !passwordsMatch ? 'Passwords do not match' : ''
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // On success, tokens are already stored by authService, navigate to content
      navigate('/')
    } catch (err: any) {
      ...
      <div className="setpassword-card">
        ...
        <div className="setpassword-header">
          ...
          <h1 className="setpassword-title">
            {logoLoaded && !logoError ? 'Create Password' : projectName}
          </h1>
          <p className="setpassword-subtitle">Set up your account password to get started</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="setpassword-form">
          ...
          <div className="setpassword-form-group">
            <label htmlFor="password" className="setpassword-label">Password</label>
