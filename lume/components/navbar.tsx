...
export const Navbar: FC<{
  ...
  return (
    <>
      ...
      <nav className='sticky top-0 left-0 right-0 z-50 bg-background/90 backdrop-blur-xs text-primary border-x-0  '>
          ...
          <div className='hidden md:flex items-center space-x-6'>
            {navitems.map(item => (
              <Anchor
                ...
                href={item.reference}
                className={
                  `hover:text-secondary text-xs transition-colors duration-200 ease-in-out font-medium flex flex-row items-center ${item.type === 'button'
                    ? 'custom-button'
